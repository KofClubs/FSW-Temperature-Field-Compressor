...
OBJ:=$(OBJ_DIR)/user_defined.o $(OBJ_DIR)/vector3.o $(OBJ_DIR)/temperature.o $(OBJ_DIR)/bitmap.o $(OBJ_DIR)/compress.o $(OBJ_DIR)/decompress.o $(OBJ_DIR)/check.o
...
$(OBJ_DIR)/check.o:$(SRC_DIR)/check.cpp $(SRC_DIR)/check.h $(SRC_DIR)/temperature.h $(SRC_DIR)/user_defined.h
